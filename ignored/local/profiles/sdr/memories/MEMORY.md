...
§
Notifly Slack evidence sources for the sdr profile: #sales-partnership C06B39NC2AW and private #revenue-report C06DEQQ2LGP are readable with Slack Web API when the bot is a member; the Slack token is in the profile .env and should not be printed.
§
