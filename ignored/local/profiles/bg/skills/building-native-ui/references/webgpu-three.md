...
**Problem:** Package installation fails with ERESOLVE

**Solution:** Use the exact version-pinned command in [Installation](#installation), which already includes `--legacy-peer-deps`.
