...
description: Use when building Expo or React Native native-feeling screens with responsive layout, native controls, semantic colors, media, animation, or visual effects.
version: 1.1.1
license: MIT
metadata:
  upstream-name: expo-native-ui
  upstream-revision: "8d72763f53c4fe11ed3ae0441b921bda821d2a74"
  bg-patch: "compatibility-1"
---

# Expo Native UI Guidelines

> Provenance: MIT-licensed BG compatibility alias preserving the retired snapshot name `building-native-ui` for Expo's current `expo-native-ui` skill at revision `8d72763f53c4fe11ed3ae0441b921bda821d2a74`.
