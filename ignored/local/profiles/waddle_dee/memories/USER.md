...
§
CS eval/SaaS: source-only; public docs/review numbers; facts≠estimates; tool-use≠quality; preserve sheet visuals; MCP discovery.
§
Docs/specs: KR humanized. Vendor architecture docs: facts≠inference, schema/UX/send paths, actionable Notifly guidance. Research MD=요약→사례→작업→링크.
§
