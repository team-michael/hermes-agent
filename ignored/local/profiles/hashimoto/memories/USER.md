...
§
When a Notifly project_id is present in alert triage output, render it as `<project_id> (<product_id>)`, e.g. `a78f6de3abdc5d7ca175486626e2ab1c (moyo)`. Skip the literal `product_id:` prefix.