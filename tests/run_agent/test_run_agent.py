...
class TestBuildApiKwargs:
    ...
    def test_workers_ai_sends_reasoning_effort_for_supported_model(self, agent, model):
    ...
    def test_workers_ai_omits_reasoning_effort_for_unsupported_model(self, agent, model):
        agent.provider = "workers-ai"
        agent.base_url = "https://api.cloudflare.com/client/v4/accounts/test/ai/v1"
        agent._base_url_lower = agent.base_url.lower()
        agent.model = model
