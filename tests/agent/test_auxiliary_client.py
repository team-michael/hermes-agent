...
class TestCustomEndpointApiKeyInheritance:
    ...
    @pytest.fixture(autouse=True)
    def _clear_runtime_main_overrides(self, monkeypatch):
        """Keep process-global runtime routing from leaking across tests."""
        import agent.auxiliary_client as ac

        monkeypatch.setattr(ac, "_RUNTIME_MAIN_API_KEY", "")
        monkeypatch.setattr(ac, "_RUNTIME_MAIN_BASE_URL", "")
